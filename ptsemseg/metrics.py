...
class runningScore(object):
    def __init__(self, n_classes, void=False):
        ...
        # self.tp = np.zeros(self.break_even_threshold, int)
        # self.fn = np.zeros(self.break_even_threshold, int)
        # self.fp = np.zeros(self.break_even_threshold, int)
    ...
    def compute_break_even(self):
        ...
        total_lp = (total_lp * self.break_even_threshold).astype(int)
        total_lp = total_lp.astype(float) / self.break_even_threshold
        ...
        # cond = np.arange(0, self.break_even_threshold).astype(float) / self.break_even_threshold
    ...
    def compute_break_even_slow(self):
        ...
        recalls = np.zeros(self.break_even_threshold, float)
        precs = np.zeros(self.break_even_threshold, float)
    ...
    def reset(self):
        ...
        self.n_lp = []
        self.n_lt = []
        self.confusion_matrix_at_threshold.fill(0)
        self._is_usable = False
