...
class pspnet(nn.Module):
    ...
    def load_pretrained_model(self, model_path):
        ...
        try:
            ...
            raise ImportError(
                "Legacy Caffe weight loading requires optional protobuf/Caffe conversion support."
            ) from exc
...
if __name__ == "__main__":
    ...
    caffemodel_dir_path = "/cvlabdata2/home/user/models"
    psp.load_pretrained_model(
        model_path=os.path.join(caffemodel_dir_path, "pspnet_101_cityscapes.pth")
    )
    # psp.load_pretrained_model(
